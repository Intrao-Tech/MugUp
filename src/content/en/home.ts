  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          cta: { label: "Book Assessment", href: "/book-assessment" },
        },
      ],
    },
    {
          ...
          cards: [
            {
              ...
              items: [
                ...
                "IELTS, SELT & Cambridge Exams",
                "University Preparation",
              ],
              image: "placeholder",
              href: "/pathways/british-education",
              linkLabel: "Explore Mug.Up Britain",
            },
            {
              title: "Mug.Up Global Integration",
              body: "Helping individuals and families build confidence, develop practical communication skills, and create new opportunities in the UK and beyond. From everyday life in Britain to professional communication and multilingual learning, our personalised programmes support successful integration, career development, and lifelong learning.",
              items: [
                "Foreign Language Programmes",
                "Academic English",
                "Professional English",
                "Life & Career in the UK",
                "Online | In-person Learning",
                "Global Opportunities",
              ],
              image: "placeholder",
              href: "/pathways/global-integration",
              linkLabel: "Explore Mug.Up Global",
            },
          ],
        },
      ],
      ...
      blocks: [
        {
          ...
          body: "Every successful journey starts with understanding where you are today and where you want to go tomorrow. Book a free assessment and receive personalised recommendations tailored to your goals. Whether you are preparing for exams, planning university applications, developing professional skills, or adapting to life in the UK, we are here to help.",
          note: "No obligation. Personalised guidance. Clear next steps.",
          cta: { label: "Book Your Free Assessment", href: "/book-assessment" },
        },
      ],
    },
  ],
