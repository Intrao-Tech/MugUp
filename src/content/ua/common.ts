...
export const common: CommonDict = {
  ...
  ui: {
    ...
    reviewSent: "Дякуємо за відгук! Він з'явиться на сайті після перевірки нашою командою.",
    formError: "Сталася помилка, повідомлення не надіслано. Перевірте поля та спробуйте ще раз.",
    bookingSent: "Дякуємо — ми отримали ваші дані. Оберіть зручний час консультації, і ми підтвердимо його електронною поштою.",
    bookingCta: "Обрати час",
